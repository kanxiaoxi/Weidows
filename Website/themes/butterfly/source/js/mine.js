 ...
 * @LastEditors: Weidows
 * @LastEditTime: 2020-08-31 23:36:18
...
$(document).ready(function (e) {
  $(".copyright").html(
    '©2020 <i style="color:#FF6A6A;animation: announ_animation 0.8s linear infinite;" class="fa fa-heartbeat"></i> Weidows'
  );
});
...
/*添加图片top*/
var top_up =
  "<img id='upj' class='upj' style='max-width: 500%; transform: translate(-70px,-70px);' src='https://cdn.jsdelivr.net/gh/lete114/CDN/Use/up.gif' title='回到顶部' >";
/*添加到返回顶部按钮下*/
        ...
        Promise.all([a, i]).then(function () {
          $("body").append(
            "<meting-js id="
              ...
              .concat(
                n,
                ' fixed="true" mini="true" order="random" listFolded="false" autoplay="true" ></meting-js>'
              )
          );
        });
      },
...
xiaokang.cheatTitle([
  "这里这里 ◕ ں ◕ ",
  "ヘ(￣ω￣ヘ)走开！",
  "https://gitee.com/Weidows2984539695/Weidows/raw/master/Website/public/images/ComicExpression/74ef2ed780ee230c08866adfa01dbe297b5467b4.png",
  "https://gitee.com/Weidows2984539695/Weidows/raw/master/Website/public/images/ComicExpression/34e594f5a6b38285aa8bc7f005861ca1b383d1e2.png",
]);
/* 全局左下角APlayer */
  // xiaokang.aplayer( {
  //   autoplay: false, //自动播放
  //   listFolded: false, //播放列表默认折叠
  //   listMaxHeight: 200, //播放列表最大高度
  //   order: "random", //音频循环顺序, 可选值: 'list', 'random'
  //   loop: "all", //音频循环播放, 可选值: 'all', 'one', 'none'
  //   theme: "#8000ff", //切换音频时的主题色，优先级低于audio.theme
  ...
  //   fixed: true, //吸底模式（fixed:true），迷你模式（mini:true)这两个必须注释掉一个
  //   // mini: true,
  //   audio: [
  //     {
  //       name: "落空",
  //       artist: "洛萱",
  //       url:
  //         "https://cdn.jsdelivr.net/gh/Artitalk/Artitalk-mp3/f2/1d/%E6%B4%9B%E8%90%B1%20-%20%E8%90%BD%E7%A9%BA.mp3",
  //       cover: "./images/Repo-Weidows/T002R300x300M000003Rz1mo3tcrsR_1.jpg",
  //       lrc: "./images/Lyric/落空-洛萱.lrc",
  //     },
  //     {},
  //   ],
  // } );
